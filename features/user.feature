Feature: Users
  ...
  Scenario: Add an existing user to the Public scope
    Given I am authenticated as "admin" in firewall "default"
      ...
      And I follow "New"
    Then I should see "New user"
    When I fill in "integrated_user_profile_form[username]" with "behatPublic"
      And I fill in "integrated_user_profile_form[password]" with "welcomePublic!"
      And I check "integrated_user_profile_form[enabled]"
      And I check "integrated_user_profile_form[groups][]"
      And I select "Public" from "integrated_user_profile_form[scope]"
      And I press "Create"
    Then I should see "The user behatPublic is created"
      And I should see "Username"
      And I should see "Relation"
      And I should see "Actions"
  ...
  Scenario: Login with a newly added user into the admin scope
    ...
    And I should see "Password"
    And I should see "Remember me"
    When I fill in "_username" with "behatPublic"
    And I fill in "_password" with "welcomePublic!"
    And I press "Login"
    Then I should see "Bad credentials."
  ...
  Scenario: Delete a user
    ...
    Then I should see "Username"
      And I should see "Relation"
      And I should see "Actions"
    When I click the icon "glyphicon-remove-circle" in the row "behatPublic"
    Then I should see "Delete user"
      And I should see "You are about to delete the user \"behatPublic\", click the delete button below to confirm the action."
      And I press "Delete"
    Then I should see "The user behatPublic is removed"
      And I should see "Username"
      And I should see "Relation"
      And I should see "Actions"
